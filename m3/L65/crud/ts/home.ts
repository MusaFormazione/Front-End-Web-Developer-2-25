...
const tabellaPizze: HTMLElement | null = document.getElementById('tabella-pizze');
...
fetch('http://localhost:3000/pizzas')
    .then(response => {
        ...
        return <Promise<Pizza[]>> response.json()
    })
    .then(pizze => {
        ...
        pizze.forEach(p => {
            ...
            btnElimina.addEventListener('click', function () {
                ...
                fetch(`http://localhost:3000/pizzas/${id}`, {
                    ...
                    .then(response => {
                        ...
                        return <Promise<null>> response.json()
                    })
                    .then(res => {
            ...
            //append solo se l'elemento esiste
...
//aggiunta pizze
const form = <HTMLFormElement|null> document.getElementById('form-crea-pizza');

form?.addEventListener('submit', (e) => {
    e.preventDefault();

    const gustoInput = <HTMLInputElement|null> document.getElementById('gusto');
    const prezzoInput = <HTMLInputElement|null> document.getElementById('prezzo');
    const disponibileInput = <HTMLInputElement|null> document.getElementById('disponibile');

    if(!gustoInput || !prezzoInput || !disponibileInput) return;
