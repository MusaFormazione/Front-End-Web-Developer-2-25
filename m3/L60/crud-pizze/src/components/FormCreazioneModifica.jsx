...
const FormCreazioneModifica = ({onAdd, onUpdate, selectedPizza, setSelectedPizza}) => {
  ...
  return (
    ...
    <div>
      <ActionButton fn={submitHandler}>{!selectedPizza ? 'Aggiungi' : 'Aggiorna'}</ActionButton>
      {selectedPizza && <ActionButton type="button" fn={removePizza}>Rimuovi selezione</ActionButton>}
    </div>
